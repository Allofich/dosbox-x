...
typedef IO_ReadHandler* (IO_ReadCalloutHandler)(const IO_CalloutObject &co,Bitu port,Bitu iolen);
typedef IO_WriteHandler* (IO_WriteCalloutHandler)(const IO_CalloutObject &co,Bitu port,Bitu iolen);
